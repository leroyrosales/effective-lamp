...
class ImageDecodeAcceleratorCapability:
    ...
    def from_json(cls, json):
        return cls(
            ...
            subsamplings=[SubsamplingFormat.from_json(
                i) for i in json['subsamplings']],
        )
...
class GPUInfo:
    ...
    def from_json(cls, json):
        return cls(
            ...
            driver_bug_workarounds=[str(i)
                                    for i in json['driverBugWorkarounds']],
            video_decoding=[VideoDecodeAcceleratorCapability.from_json(
                i) for i in json['videoDecoding']],
            video_encoding=[VideoEncodeAcceleratorCapability.from_json(
                i) for i in json['videoEncoding']],
            image_decoding=[ImageDecodeAcceleratorCapability.from_json(
                i) for i in json['imageDecoding']],
            aux_attributes=dict(json['auxAttributes']
                                ) if 'auxAttributes' in json else None,
            feature_status=dict(json['featureStatus']
                                ) if 'featureStatus' in json else None,
        )

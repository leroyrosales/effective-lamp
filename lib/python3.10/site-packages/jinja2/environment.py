...
class Environment:
    ...
    def overlay(
        ...
        autoescape: t.Union[bool, t.Callable[[
            t.Optional[str]], bool]] = missing,
    ...
    def compile(
        ...
        try:
            ...
            source = self._generate(
                source, name, filename, defer_init=defer_init)
            if raw:
                return source
            if filename is None:
                filename = "<template>"
    ...
    def compile_templates(
        ...
        if zip is not None:
            ...
            zip_file = ZipFile(
                target, "w", dict(deflated=ZIP_DEFLATED,
...
class TemplateModule:
    ...
    def __init__(
        ...
        if body_stream is None:
            ...
            body_stream = list(
                template.root_render_func(context))  # type: ignore
    ...
    def dump(
        ...
        try:
            if encoding is not None:
                iterable = (x.encode(encoding, errors)
                            for x in self)  # type: ignore
            else:

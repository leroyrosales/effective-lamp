...
async def to_thread_run_sync(sync_fn, *args, cancellable=False, limiter=None):
    ...
    * If ``cancellable=True``, then this function immediately raises
    ...
    # raise early if cancellable.__bool__ raises
        ...
        try:
            ...
            if inspect.iscoroutine(ret):
                ...
                raise TypeError(
                    ...
                    "asynchronous".format(
                        getattr(sync_fn, "__qualname__", sync_fn))
                )
    ...
    def deliver_worker_fn_result(result):
        try:
            current_trio_token.run_sync_soon(
                report_back_in_trio_thread_fn, result)
    ...
    try:
        start_thread_soon(contextvars_aware_worker_fn,
    ...
    **Locating a Trio Token**: There are two ways to specify which
    ...
    def callback(q, afn, args):
        ...
        try:
            ...
            q.put_nowait(
                outcome.Error(trio.RunFinishedError(

        ...
        def must_match_these_tokens(s, l, t):
            ...
            if theseTokens != matchTokens:
                raise ParseException(
                    s, l, "Expected {}, found{}".format(
                        matchTokens, theseTokens)
                )
...
def one_of(
    ...
    *,
    ...
    if caseless:
        def isequal(a, b): return a.upper() == b.upper()
        def masks(a, b): return b.upper().startswith(a.upper())
        parseElementClass = CaselessKeyword if asKeyword else CaselessLiteral
    else:
        def isequal(a, b): return a == b
        def masks(a, b): return b.startswith(a)
...
def nested_expr(
    ...
    *,
    ...
    if ignoreExpr is not None:
        ret <<= Group(
            Suppress(opener) + ZeroOrMore(ignoreExpr |
...
InfixNotationOperatorArgType = Union[
    ParserElement, str, Tuple[Union[ParserElement,
                                    str], Union[ParserElement, str]]
]
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[]):
    ...
    INDENT = (Empty() + Empty().set_parse_action(checkSubIndent)
              ).set_name("INDENT")
